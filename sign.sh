...
IPA="/Volumes/ssd256/TestEmptyProject/out/production/TestEmptyProject/TestEmptyProject.ipa"

# The provisioning profile for your application
PROVISIONING_PROFILE="/Volumes/ssd256/TestEmptyProject/cert/sboiko_alt/dev_christmas_sweeper_3.mobileprovision"
...
SIGNING_IDENTITY="iPhone Developer: Alexandr Boiko (B73426NW89)"
...
OUTPUT=.
WORKING_DIR="/Volumes/ssd256/TestEmptyProject/out/production/TestEmptyProject/tmp"
